...
\section{Misclassification detection}
	...
	\begin{figure}[t]
		...
		\center{\caption{PR-curve for misclassification detection by TU. $\delta(h^i, \textbf{y})$}}
	\end{figure}	
	...
	\begin{figure}[t]
		...
		\center{\caption{ROC for misclassification detection by TU. $\delta(h^i, \textbf{y})$}}
	\end{figure}
